...
Shader "Custom/Hidden/AsciiArtFx"
{
    Properties 
    {
        ...
        _FastTime("Fast Range?", Range(0,1)) = 0
    }
...
ENDCG
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            Blend SrcAlpha DstColor //Blend Factors : One - Zero - SrcColor - SrcAlpha - DstColor - DstAlpha - OneMinusSrcColor - OneMinusSrcAlpha - OneMinusDstColor - OneMinusDstAlpha
